...
def get_days_from_today(date):
    try:
        ...
        dif_date=current_date-specified_date
        return dif_date.days
    except ValueError:
        return ("Error: Date format is incorrect. Please provide the date in 'YYYY-MM-DD' format.")


print(get_days_from_today('2021-10-09'))
print(get_days_from_today('2025-10-09'))
print(get_days_from_today('10-09-2025'))
